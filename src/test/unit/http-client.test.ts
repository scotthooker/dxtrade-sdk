...
describe('HttpClient', () => {
  ...
  describe('request method', () => {
    ...
    it('should include authentication headers', async () => {
      mockFetch.mockResponse('/auth-test', new MockHttpResponse(200, { success: true }));
    ...
    it('should include idempotency key', async () => {
      mockFetch.mockResponse('/idempotent', new MockHttpResponse(200, { success: true }));
    ...
    it('should handle query parameters', async () => {
      mockFetch.mockResponse('/search', new MockHttpResponse(200, { success: true }));
  ...
  describe('retry logic', () => {
    it('should retry on retryable errors', async () => {
      ...
      mockFetch.mockResponse('/retry-test', new MockHttpResponse(200, { success: true }));
  ...
  describe('rate limiting', () => {
    ...
    it('should update rate limits from response headers', async () => {
      ...
      mockFetch.mockResponse('/rate-limit', new MockHttpResponse(200, { success: true }, headers));
  ...
  describe('authentication types', () => {
    it('should handle session authentication', async () => {
      ...
      mockFetch.mockResponse('/session-test', new MockHttpResponse(200, { success: true }));
    ...
    it('should handle HMAC authentication', async () => {
      ...
      mockFetch.mockResponse('/hmac-test', new MockHttpResponse(200, { success: true }));
  ...
  describe('idempotency handling', () => {
    it('should reject duplicate idempotency keys', async () => {
      ...
      mockFetch.mockResponse('/test', new MockHttpResponse(200, { success: true }));
      mockFetch.mockResponse('/test', new MockHttpResponse(200, { success: true }));
    ...
    it('should generate unique idempotency keys', async () => {
      mockFetch.mockResponse('/test1', new MockHttpResponse(200, { success: true }));
      mockFetch.mockResponse('/test2', new MockHttpResponse(200, { success: true }));
